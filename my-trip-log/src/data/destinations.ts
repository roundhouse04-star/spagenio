...
export const DESTINATIONS: DestinationCity[] = [
  {
    ...
    flag: '🇰🇷',
    icon: '🏙️',
    categories: ['food', 'shopping', 'culture', 'city'],
    seasons: ['spring', 'autumn'],
    highlights: ['경복궁', '남산타워', '명동', '강남', '홍대'],
    tips: [
      '교통카드 T-money 한 장이면 지하철/버스/택시 다 됨',
      '지하철이 제일 빠르고 정확 (1~9호선 + 공항철도)',
      '카페/식당 대부분 카드 결제 가능',
      '벚꽃은 3월 말~4월 초, 단풍은 10월 말',
    ],
  ...
  },
  {
    ...
    flag: '🇰🇷',
    icon: '🌊',
    categories: ['leisure', 'food', 'nature', 'city'],
    seasons: ['spring', 'summer', 'autumn'],
    highlights: ['해운대', '광안리', '감천문화마을', '자갈치시장', '태종대'],
    tips: [
      '지하철 1~4호선 + 부산김해경전철 + 동해선까지 촘촘',
      '회·밀면·돼지국밥 필수 (자갈치시장 추천)',
      '해운대는 여름엔 혼잡, 봄·가을이 좋음',
      '벚꽃은 4월 초, 감천문화마을 오전 방문 추천',
    ],
