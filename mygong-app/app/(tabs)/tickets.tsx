...
import { Empty, Divider } from '@/components/UI';
...
export default function TicketsScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.bg }} edges={['top']}>
      ...
      {/* Filter chips — fixed height container 로 잘림 방지 */}
      ...
      {tickets.length === 0 ? (
        ...
        <ScrollView contentContainerStyle={{ paddingVertical: Spacing.md, paddingBottom: 120 }}>
...
const styles = StyleSheet.create({
  ...
  // 칩 영역 — 명시적 높이 + 충분한 padding 으로 잘림 방지
  chipsRow: {
    height: 56,                  // 칩 높이 + 위아래 여백
