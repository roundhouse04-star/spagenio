...
with_node \
  ...
  --target "/Users/roundhouse04/Desktop/TravellogApp/ios/Pods/Target Support Files/Pods-Travellog/ExpoModulesProvider.swift" \
  --entitlement "/Users/roundhouse04/Desktop/TravellogApp/ios/Travellog/Travellog.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-location"
