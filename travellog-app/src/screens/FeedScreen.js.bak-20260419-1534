...
const S = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: colors.borderLight },
  tab: { flex: 1, paddingVertical: 14, alignItems: 'center', borderBottomWidth: 1.5, borderBottomColor: 'transparent' },
